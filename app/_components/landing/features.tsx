      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-4">
          <Card className="p-4 flex flex-col gap-4 items-center flex-1">
            ...
            <h2 className="text-2xl text-center">GPS TRACKING</h2>
            <p className="text-sm">
          ...
          <Card className="p-4 flex flex-col gap-4 items-center flex-1">
            ...
            <h2 className="text-2xl text-center">TEMPERATURE MONITORING</h2>
            <p className="text-sm">
          ...
          <Card className="p-4 flex flex-col gap-4 items-center flex-1">
            ...
            <h2 className="text-2xl text-center">ACTIVITY MONITORING</h2>
            <p className="text-sm">
          ...
          <Card className="p-4 flex flex-col gap-4 items-center flex-1">
            ...
            <h2 className="text-2xl text-center">HEART RATE MONITORING</h2>
            <p className="text-sm">
